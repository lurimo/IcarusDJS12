...
module.exports = {
    name: 'ban',
    category: 'mod',
    description: 'Bane alguem do servidor.',
    aliases: ['banir'],
    run: async (bot, message, args) => {
        ...
        let banEmbed = new Discord.MessageEmbed()
            ...
            .addField("Punição efetuada:", "Banimento", true)
            .addField("Autor da punição:", `@${message.author.tag}`)
            .addField("Vítima:", `${user}`, true)
            .addField("Razão:", `${reason}`, true)
            .setTimestamp()
            .setFooter("Banimento efetuado em:", aicon);

        user.send(`Venho tristemente lhe informar que você foi **BANIDO** da **BASE SUPER SECRETA**.`)
